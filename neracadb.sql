...
CREATE TABLE IF NOT EXISTS `penjualan_konfirmasi` (
...
(7, 'A0001', 'Sepatu Ibu-ibu', 3, 4, 6, '<p>Deskripsi Sepatu Ibu-ibu</p>\r\n', 169000, 30, 0, 1),
(8, 'A0002', 'Sepatu Anak-anak', 3, 4, 5, '<p>Sepatu anak-anak</p>\r\n', 89900, 30, 0, 4),
(9, 'A0003', 'Sepatu Balet Remaja', 3, 4, 5, '<p>Deskripsi Sepatu Balet Remaja</p>\r\n', 189000, 20, 0, 1),
(10, 'A0004', 'Sepatu Kets Remaja', 3, 4, 5, '<p>Deskripsi Sepatu Kets Remaja</p>\r\n', 200000, 30, 0, 3);
...
DROP TABLE IF EXISTS `produk_warna`;
CREATE TABLE IF NOT EXISTS `produk_warna` (
  `warna_id` int(11) NOT NULL AUTO_INCREMENT,
...
(3, 'Supplier Sepatu', 'Alamat', '123123', 12);
...
CREATE TABLE IF NOT EXISTS `toko_mutasi` (
...
CREATE TABLE IF NOT EXISTS `toko_mutasi_detail` (
...
(1, 'Administrator', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'ava-c4ca4238a0b923820dcc509a6f75849b.jpg', 'aktif', '2016-06-04 22:01:36', NULL),
(4, 'Operator', 'op', '11d8c28a64490a987612f2332502467f', 'op', '', 'aktif', '2016-07-16 15:52:03', NULL),
(5, 'Pimpinan', 'bos', '15fc4a53992beba40ae91e5244e79dff', 'bos', '', 'aktif', '2016-07-16 15:52:46', NULL),
(9, 'Heru', 'heru', 'a648ab9a3e32c5f3f6e9ddbd41c0530f', 'member', '', 'aktif', '2016-07-16 15:44:02', NULL),
(8, 'Esti Oneng', 'jkt', 'a936a0058e0963ff14134e1d47dc8107', 'member', '', 'aktif', '2016-05-21 19:08:30', NULL),
(12, 'Supplier Akun 1', 's1', '8ddf878039b70767c4a5bcf4f0c4f65e', 'supplier', '', 'aktif', '2016-07-13 23:09:10', NULL);
