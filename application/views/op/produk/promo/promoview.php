	...
	<tbody>
		...
		if(!empty($data))
		{
			...
			<tr>				
				...
				<td><?=$berlaku;?></td>				
				<td>
					<a href="<?=base_url(akses().'/produk/promo/produk').'?id='.$id;?>" class="btn btn-xs btn-default">Produk</a>
					<a href="<?=base_url(akses().'/produk/promo/gambar').'?id='.$id;?>" class="btn btn-xs btn-default">Banner</a>
